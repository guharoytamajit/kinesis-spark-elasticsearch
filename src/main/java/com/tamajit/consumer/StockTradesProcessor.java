...
import com.tamajit.util.ConfigurationUtils;
import com.tamajit.util.CredentialUtils;
...
public class StockTradesProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String applicationName = "StockTradeStream7";//args[0];
        String streamName = "test-kinesis";//args[1];
